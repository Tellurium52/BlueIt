...
$str = curPageURL();
$_SESSION['comment_id'] = substr($str,-7);
			...
			<main>
				<div id="content">
					<div class="innertube">
						...
						<?php
						$sql = "SELECT User_idUser, Comment_Description
						FROM Comment
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								...
								echo
						'<form action="http://student.seas.gwu.edu/~junjie2412/CommentEdited.php" method="get" id="comment">
						<textarea rows="4" cols="100" name = "comdes" >'. $row["Comment_Description"].'</textarea>
