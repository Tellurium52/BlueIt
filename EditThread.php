...
<html>
	<head>
		...
		<title>BlueIt - Edit Comment</title>
		<style type="text/css">
			...
			<main>
				<div id="content">
					<div class="innertube">
						...
						<?php
						$sql = "SELECT User_idUser, Thread_Name, Thread_Description
						FROM Threads
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								...
								echo
						'<form action="http://student.seas.gwu.edu/~junjie2412/ThreadEdited.php" method="get" id="thread">
						<input type="text" name="threadname" value = "'. $row["Thread_Name"].'"><br>
						<textarea rows="4" cols="100" name = "thredes" >'. $row["Thread_Description"].'</textarea>
