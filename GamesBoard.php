...
session_start();
$_SESSION['board_id'] = 3;
$_SESSION['board_name'] = 'Games';
?>
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>BlueIt - Games</title>
		<style type="text/css">
			...
			<main>
				<div id="content">
					...
					<div class ="boards">
						...
						<h3>Games</h3>
						<p>We don't care about platform, generation, or genre. If it's a game you can discuss it here. </p>
						<?php
