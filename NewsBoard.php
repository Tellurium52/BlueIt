...
session_start();
$_SESSION['board_id'] = 1;
$_SESSION['board_name'] = 'News';
?>
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>BlueIt - News</title>
		<style type="text/css">
			...
			<main>
				<div id="content">
					...
					<div class ="boards">
						...
						<p>A board where Admin Junjinator tells you all about the wonderful updates to this forum in capslock.</p>
						<?php
						...
						while($row = $result->fetch_assoc()) {
							echo '<table style="width:100%">
									<tr>
										<th width="50%"><a href = "/~junjie2412/Thread.php?id=0000000'. $row["idThreads"].'">' . $row["Thread_Name"]. '</a></th>
