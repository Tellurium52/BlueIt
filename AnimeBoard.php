...
session_start();
$_SESSION['board_id'] = 4;
$_SESSION['board_name'] = 'Anime';
?>
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>BlueIt - Anime</title>
		<style type="text/css">
		...
		<div id="wrapper">
			...
			<main>
				<div id="content">
					...
					<div class ="boards">
						<h3>Anime</h3>
						<p>Anything and everything pertaining to eastern animation. </p>
						<?php
						...
						<?php
						$sql = "SELECT Threads.Thread_Name, idThreads, User.User_Name, Threads.Thread_Creation_Date, Bump_Date, idUser
								FROM Threads
								INNER JOIN User
								ON Threads.User_idUser = User.idUser
								AND Threads.Board_idBoard = 4
