...
$ComDes = $_GET["comdes"];
$ComDes = mysql_real_escape_string($ComDes);
$UserID = $_SESSION["user_id"];
$sql = "UPDATE Comment
		SET Comment_Description = '".$conn->real_escape_string($_GET["comdes"])."'
		WHERE idComment = '$Comid'";
	...
	<body>
		<div id="wrapper">
			...
			<main>
				<div id="content">
					<div class="innertube">
						<h1>Your Comment has been edited!</h1>
						<?php
						echo '<li><a href="/~junjie2412/UserProfile.php?id=0000000'. $_SESSION['user_id'].'">Back to your profile page.</a></li>';
						$sql = "SELECT Threads_idThreads
								FROM Comment
								WHERE idComment = '$Comid'";
						$result = $conn->query($sql);
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
						echo '<li><a href="/~junjie2412/Thread.php?id=0000000'.$row["Threads_idThreads"].'">See your newly edited comment.</a></li>';
							}
							}
						?>
				</div>
