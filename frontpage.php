		...
		<div id="wrapper">
			...
			<main>
				<div id="content">
					...
					<div class ="boards">
						<li><a href="/~junjie2412/NewsBoard.php">
						<h3>News and Announcements</h3>
						<p>A board where Admin Junjinator tells you all about the wonderful updates to this forum in capslock.</p></a></li>
						<li><a href="/~junjie2412/GamesBoard.php">
						<h3>Games</h3>
						<p>We don't care about platform, generation, or genre. If it's a game you can discuss it here. </p></a></li>
						<li><a href="/~junjie2412/MoviesBoard.php">
						<h3>Movies</h3>
						<p>Film, actors, updates, directors, producers, and even the history of cinema. All of it can be found on the Movies board. </p></a></li>
						<li><a href="/~junjie2412/AnimeBoard.php">
						<h3>Anime</h3>
						<p>Anything and everything pertaining to eastern animation. </p></a></li>
						<li><a href="/~junjie2412/MiscBoard.php">
						<h3>Miscellaneous </h3>
						<p>Everything else. </p></a></li>
